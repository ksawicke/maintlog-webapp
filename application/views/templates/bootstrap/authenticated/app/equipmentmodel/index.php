<a href="<?php echo base_url('app/addEquipmentmodel'); ?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Equipment Model</button></a><br /><br />
...
<table id="equipmentmodelList" class="table table-bordered table-striped display nowrap">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?php echo base_url('app/addEquipmentmodel/' . $e['id']); ?>"><button type="button" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></button>&nbsp;<a href="<?php echo base_url('equipmentmodel/delete/' . $e['id']); ?>"><button type="button" class="btn btn-sm btn-primary" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
        </tr>
        <?php } ?>
    </tbody>
</table>
