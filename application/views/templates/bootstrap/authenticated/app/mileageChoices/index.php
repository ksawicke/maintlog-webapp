<a href="<?php echo base_url('index.php/app/addMileageChoice'); ?>"><button type="button" class="btn btn-success"><i class="fas fa-plus-square" style="color:#fff !important;"></i>&nbsp;&nbsp;Add Milage Choice</button></a><br /><br />

<table id="mileageChoiceList" class="table table-bordered table-striped" width="100%">
    <thead>
        <tr>
